...
bool Xml::get_element(const char * element_name, T & element_value)
{
    ...
    return (goofer_string_to_type(str_element_value, element_value));
}
...
bool Xml::get_child_element(const char * child_element_name, T & child_element_value)
{
    ...
    return (goofer_string_to_type(str_child_element_value, child_element_value));
}
...
{
    std::string str_element_value;
    if (!goofer_type_to_string(element_value, str_element_value))
    {
        return (false);
    }
...
{
    std::string str_child_element_value;
    if (!goofer_type_to_string(child_element_value, str_child_element_value))
    {
        return (false);
    }
...
bool Xml::get_element_block(const char * element_name, const char * child_element_name, bool ignore_empty_value, std::list<T> & child_element_value_list)
{
    ...
    return (goofer_string_to_type(str_child_element_value_list, child_element_value_list));
}
...
{
    std::list<std::string> str_child_element_value_list;
    if (!goofer_type_to_string(child_element_value_list, str_child_element_value_list))
    {
        return (false);
    }
...
bool Xml::get_attribute(const char * attribute_name, T & attribute_value)
{
    ...
    return (goofer_string_to_type(str_attribute_value, attribute_value));
}
...
bool Xml::get_child_attribute(const char * child_element_name, const char * child_attribute_name, T & child_attribute_value)
{
    ...
    return (goofer_string_to_type(str_child_attribute_value, child_attribute_value));
}
...
{
    std::string str_attribute_value;
    if (!goofer_type_to_string(attribute_value, str_attribute_value))
    {
        return (false);
    }
...
{
    std::string str_child_attribute_value;
    if (!goofer_type_to_string(child_attribute_value, str_child_attribute_value))
    {
        return (false);
    }
