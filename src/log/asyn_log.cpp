...
static thread_return_t GOOFER_STDCALL write_file_run(thread_argument_t argument = nullptr)
{
...
void AsynLog::save_record(GOOFER_LOG_LEVEL log_level, const char * data, size_t size)
{
    Guard<ThreadLocker> record_guard(m_current_record_locker);
