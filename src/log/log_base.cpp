...
LogBase::LogBase(const std::string & path, const std::string & log_type, GOOFER_LOG_LEVEL min_log_level, size_t max_file_size, bool output_to_console)
...
void LogBase::write(const char * data, size_t size)
{
    ...
    goofer_rename_safe(m_filename.c_str(), datetime_filename.c_str());
