...
static thread_return_t GOOFER_STDCALL process_wait_exit_thread_run(thread_argument_t argument)
{
...
static thread_return_t GOOFER_STDCALL process_release_thread_run(thread_argument_t argument)
{
    s_stdout_locker.acquire();
...
void test_process(void)
{
    ...
    goofer_create_detached_process(command_line);
