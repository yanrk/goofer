...
void test_library_1(void)
{
    ...
    do
    {
        simple_math_calc_func simple_add = reinterpret_cast<simple_math_calc_func>(goofer_library_symbol(library, "simple_add"));
        if (nullptr == simple_add)
        {
            printf("%s\n", goofer_library_error());
            break;
        }
        simple_math_calc_func simple_sub = reinterpret_cast<simple_math_calc_func>(goofer_library_symbol(library, "simple_sub"));
        if (nullptr == simple_sub)
        {
            printf("%s\n", goofer_library_error());
            break;
        }
        simple_math_calc_func simple_mul = reinterpret_cast<simple_math_calc_func>(goofer_library_symbol(library, "simple_mul"));
        if (nullptr == simple_mul)
        {
            printf("%s\n", goofer_library_error());
            break;
        }
        simple_math_calc_func simple_div = reinterpret_cast<simple_math_calc_func>(goofer_library_symbol(library, "simple_div"));
        if (nullptr == simple_div)
        {
            printf("%s\n", goofer_library_error());
            break;
        }
        simple_math_calc_func simple_mod = reinterpret_cast<simple_math_calc_func>(goofer_library_symbol(library, "simple_mod"));
        ...
        create_math_func create_math = reinterpret_cast<create_math_func>(goofer_library_symbol(library, "create_math"));
        ...
        destroy_math_func destroy_math = reinterpret_cast<destroy_math_func>(goofer_library_symbol(library, "destroy_math"));
    ...
    if (0 == goofer_library_release(library))
    {
        printf("%s\n", goofer_library_error());
        return;
    }
