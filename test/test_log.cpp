...
static void test_log_with_write_mode_1(GOOFER_LOG_WRITE_MODE write_mode, const char * mode)
{
    GOOFER_LOG_CONFIG log_config;
    log_config.log_file_path = "./test_log/log_1/";
    if (nullptr != mode)
    {
...
static void test_log_with_write_mode_2(GOOFER_LOG_WRITE_MODE write_mode, const char * mode)
{
    GOOFER_LOG_CONFIG log_config;
    log_config.log_file_path = "./test_log/log_2/";
    if (nullptr != mode)
    {
        log_config.log_file_path += mode;
    }
